        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 lg:gap-6">
          ...
          <div className="reveal-up group relative flex flex-col p-5 lg:p-6 rounded-3xl bg-[#F9F6F0] bg-gradient-to-b from-white/60 to-transparent border border-[#D4C7B8]/60 shadow-[inset_0_1px_1px_rgba(255,255,255,0.8),0_8px_32px_-8px_rgba(58,49,44,0.06)] hover:shadow-[inset_0_1px_1px_rgba(255,255,255,0.8),0_16px_48px_-12px_rgba(58,49,44,0.08)] transition-all duration-500" style={{ transitionDelay: '0.2s' }}>
            <div className="flex items-center justify-between mb-4">
              ...
              <iconify-icon icon="solar:ruler-linear" className="text-lg text-[#8C8A79]" strokeWidth="1.5"></iconify-icon>
            </div>
            
            <div className="aspect-[4/3] w-full mb-5 relative rounded-xl overflow-hidden bg-[#F2EFE9] border border-[#D4C7B8]/60">
              <img src="https://gabriellearruda.com/wp-content/uploads/2021/06/kibbeexamples.jpg" alt="Draped garment" className="w-full h-full object-cover grayscale-[20%] opacity-90 group-hover:opacity-100 transition-opacity duration-700" />
              <div className="absolute inset-0 bg-[#201A17]/10 mix-blend-multiply"></div>
              <svg className="absolute inset-0 w-full h-full z-10 opacity-50 mix-blend-overlay pointer-events-none" viewBox="0 0 100 100" preserveAspectRatio="none">
                <path d="M 40 20 Q 50 30 45 60 Q 40 80 35 95" fill="none" stroke="white" strokeWidth="0.5" strokeDasharray="2 2" className="structural-line" style={{ animationDuration: '6s' }}></path>
                <path d="M 60 20 Q 50 30 55 60 Q 60 80 65 95" fill="none" stroke="white" strokeWidth="0.5" strokeDasharray="2 2" className="structural-line" style={{ animationDuration: '6s' }}></path>
              </svg>
            </div>
          ...
          <div className="reveal-up group relative flex flex-col p-5 lg:p-6 rounded-3xl bg-[#F9F6F0] bg-gradient-to-b from-white/60 to-transparent border border-[#D4C7B8]/60 shadow-[inset_0_1px_1px_rgba(255,255,255,0.8),0_8px_32px_-8px_rgba(58,49,44,0.06)] hover:shadow-[inset_0_1px_1px_rgba(255,255,255,0.8),0_16px_48px_-12px_rgba(58,49,44,0.08)] transition-all duration-500" style={{ transitionDelay: '0.3s' }}>
            <div className="flex items-center justify-between mb-4">
              ...
              <iconify-icon icon="solar:palette-linear" className="text-lg text-[#8C8A79]" strokeWidth="1.5"></iconify-icon>
            </div>
            
            <div className="aspect-[4/3] w-full mb-5 relative rounded-xl overflow-hidden bg-[#F2EFE9] border border-[#D4C7B8]/60">
              <img src="https://cdn.prod.website-files.com/5eca30fd2b50b671e2107b06/60b9022d327540475afd2b49_Twelve%20Seaosons%20Colour%20Analysis.webp" alt="Skin tone and light" className="w-full h-full object-cover object-top opacity-90 group-hover:opacity-100 transition-opacity duration-700" />
              <div className="absolute bottom-4 left-4 right-4 flex justify-between gap-1 p-2 bg-[#F9F6F0]/80 backdrop-blur-md rounded-lg border border-[#D4C7B8]/50 shadow-sm">
          ...
          <div className="reveal-up group relative flex flex-col p-5 lg:p-6 rounded-3xl bg-[#F9F6F0] bg-gradient-to-b from-white/60 to-transparent border border-[#D4C7B8]/60 shadow-[inset_0_1px_1px_rgba(255,255,255,0.8),0_8px_32px_-8px_rgba(58,49,44,0.06)] hover:shadow-[inset_0_1px_1px_rgba(255,255,255,0.8),0_16px_48px_-12px_rgba(58,49,44,0.08)] transition-all duration-500" style={{ transitionDelay: '0.4s' }}>
            <div className="flex items-center justify-between mb-4">
              ...
              <iconify-icon icon="solar:sparkles-linear" className="text-lg text-[#8C8A79]" strokeWidth="1.5"></iconify-icon>
            </div>
            
            <div className="aspect-[4/3] w-full mb-5 relative rounded-xl overflow-hidden bg-[#F2EFE9] border border-[#D4C7B8]/60">
              <img src="https://cdn.prod.website-files.com/5eca30fd2b50b671e2107b06/60f802b8a0b822634c101106_Style%20Essences%20Spectrum%20Book.webp" alt="Expressive posture" className="w-full h-full object-cover object-top opacity-90 group-hover:opacity-100 transition-opacity duration-700" />
              <div className="absolute inset-0 bg-gradient-to-t from-[#201A17]/60 via-transparent to-transparent"></div>
